...
RESULT_CPU_DATA_FILE="result.data.probability.cpu"
RESULT_MEMORY_DATA_FILE="result.data.probability.memory"

touch $RESULT_CPU_DATA_FILE
touch $RESULT_MEMORY_DATA_FILE

HEADER_CPU_DATA_FILE="cpu, probability"
HEADER_MEMORY_DATA_FILE="memory, probability"

...
# memory usage data stored in the given files whose names are passed
# as argument.
#
# Usage:
# R --slave --args mrbench_filename testdfsio_read1_filename testdfsio_write1_filename testdfsio_read2_filename testdfsio_write2_filename image_filename < plot_table_memory.r
# 
# Arguments:
